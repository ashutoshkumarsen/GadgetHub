...
public class ShippedItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(userType==null||!userType.equalsIgnoreCase("admin")){
            ...
            TransationDao transactionDao = new TransationDaoImpl();
            UserDao userDao=new UserDaoImpl();
            Map<String, String> user_Id=new HashMap<>();
            Map<String, String> user_address=new HashMap<>();
            for(OrderPojo o:orders){
                user_Id.put(o.getOrderId(),transactionDao.getUserId(o.getOrderId()) );
                user_address.put(transactionDao.getUserId(o.getOrderId()), userDao.getUserAddress(transactionDao.getUserId(o.getOrderId())));
            }
