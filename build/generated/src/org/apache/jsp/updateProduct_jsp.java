    ...
    try {
      ...
      out.write("        ");
            ...
            if(product==null){
                ...
                product = pd.getProductDetails((String)request.getParameter("prodId"));
            }
      ...
      out.print(ptype.equalsIgnoreCase("mobile")?"selected":"");
      out.write(">MOBILE</option> \n");
      out.write("                                <option value=\"tv\" ");
      out.print(ptype.equalsIgnoreCase("tv")?"selected":"Empty String");
      out.write(">TV</option> \n");
      out.write("                                <option value=\"camera\" ");
      out.print(ptype.equalsIgnoreCase("camera")?"selected":"");
      out.write(">CAMERA</option> \n");
      out.write("                                <option value=\"laptop\" ");
      out.print(ptype.equalsIgnoreCase("laptop")?"selected":"");
      out.write(">LAPTOP</option> \n");
      out.write("                                <option value=\"tablet\" ");
      out.print(ptype.equalsIgnoreCase("tablet")?"selected":"");
      out.write(">TABLET</option> \n");
      out.write("                                <option value=\"speaker\" ");
      out.print(ptype.equalsIgnoreCase("speaker")?"selected":"");
      out.write(">SPEAKER</option> \n");
      out.write("                                <option value=\"other\" ");
      out.print(ptype.equalsIgnoreCase("other")?"selected":"");
      ...
      out.write("            <p><i class=\"fa-solid fa-phone\"></i> Phone : +91 9555571078</p>\n");
      out.write("            <p>\n");
      out.write("              <i class=\"fa-solid fa-envelope\"></i> Email : anvesh9555@gmail.com\n");
      out.write("            </p>\n");
