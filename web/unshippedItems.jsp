                ...
                <table class="table table-hover table-sm">
                    ...
                    <tbody>
                        ...
                        <%
                            ...
                            Map<String, String> user_Id = (Map<String, String>) request.getAttribute("userId");
                            Map<String, String> user_address = (Map<String, String>) request.getAttribute("userAddress");
                            int count = 0;
